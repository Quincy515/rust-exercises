...
impl ImageSpec {
    pub fn new(specs: Vec<Spec>) -> Self { Self { specs } }
}
...
impl From<resize::SampleFilter> for SamplingFilter {
    fn from(v: resize::SampleFilter) -> Self {
        match v {
            ...
            resize::SampleFilter::CatmullRow => SamplingFilter::CatmullRom,
            resize::SampleFilter::Gaussian => SamplingFilter::Gaussian,
            resize::SampleFilter::Lanczos => SamplingFilter::Lanczos3,
        }
    }
}
...
mod tests {
    ...
    fn encoded_spec_could_be_decoded() {
        ...
        let spec3 = Spec::new_padding_bottom(20);
